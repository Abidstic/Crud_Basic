...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3373458237ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=employee_db&table=table_employee">`employee_db`.`table_employee`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_item">`foodies_submission_final`.`table_item`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_supply_details">`foodies_submission_final`.`table_supply_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_supply">`foodies_submission_final`.`table_supply`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_supplier">`foodies_submission_final`.`table_supplier`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_sales_details">`foodies_submission_final`.`table_sales_details`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_order">`foodies_submission_final`.`table_order`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_category">`foodies_submission_final`.`table_category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_customer">`foodies_submission_final`.`table_customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=foodies_submission_final&table=table_expenditure">`foodies_submission_final`.`table_expenditure`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7a757c3e693c615d7c5f677e56425d70">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="employee_db" targettable="">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE table_employee(
    ...
    PRIMARY KEY (Emp_Id)
                            ...
                            targetdb="employee_db" targettable="table_employee">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `table_employee`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="employee_db" targettable="table_employee">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO table_employee(Emp_Name,Emp_Code,Emp_Salary)
VALUES
(&#039;Monir&#039;,&#039;emp1&#039;,15000),
(&#039;Sahel&#039;,&#039;emp2&#039;,12000),
(&#039;Dhanus&#039;,&#039;emp3&#039;,20000),
(&#039;Sharif&#039;,&#039;emp4&#039;,15000),
(&#039;Galib&#039;,&#039;emp5&#039;,140000);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="employee_db" targettable="table_employee">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `table_employee`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="foodies_submission_final" targettable="table_item">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Query failed
                            ...
                            <span class="text targetdb">
            Database
                            : <span>foodies_submission_final</span>
                    </span>
                            <span class="text query_time">
            Queried time
                            : <span>During current session</span>
                            ...
                            <span class="query">SELECT * FROM `table_item`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="foodies_submission_final" targettable="table_item">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE PROCEDURE `sp_EmployeeAddOrUpdate`(
    IN _ID INT,
    IN _NAME VARCHAR(50),
    IN _Code VARCHAR(20),
    IN _Salary INT
...
BEGIN
        IF _ID = 0 THEN
    INSERT INTO table_employee(Emp_Name, Emp_Code, Emp_Salary)
	VALUES(_NAME, _Code, _Salary);
SET
    _ID = LAST_INSERT_ID() ; ELSE
UPDATE
    table_employee
SET
    Emp_Name = _NAME, Emp_Code = _Code, Emp_Salary = _Salary
WHERE
    Emp_Id = _ID ;
    END IF ;
SELECT
    ...
    END;</span>
            ...
            Queried time
                            ...
                            <span class="query">CALL sp_EmployeeAddOrUpdate(0, &#039;Abid&#039;, &#039;SUST3210&#039;, 3000);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="employee_db" targettable="table_employee">
                            <div class="action_content">
